module Aikido::Redirection
  class Configuration
    attr_reader   :assailant_header, #Defaults to "X-AIKIDO-ASSAILANT" This is what the middleware checks for before redirecting
    ...
    def get_redirect_query_params=(params)
      raise ArgumentError,
        ...
        @get_redirect_query_params = params
    end
    ...
    def other_redirect_query_params=(params)
        ...
        @other_redirect_query_params = params
    end

    def get_redirect_message=(message)
      raise ArgumentError,
        "The get_redirect_message option is expected to be a String" unless message.is_a? String
        @get_redirect_message = message
    end

    def other_redirect_message=(message)
      raise ArgumentError,
        "The other_redirect_message option is expected to be a String" unless message.is_a? String
      @other_redirect_message = message
    end
  end
end
